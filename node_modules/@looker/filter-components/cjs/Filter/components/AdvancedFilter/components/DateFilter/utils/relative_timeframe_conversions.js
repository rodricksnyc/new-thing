...
const filterModelToRelativeTimeframeModel = filterModel => {
  const day = filterModel.day,
        end = filterModel.end,
  ...
  if (type === 'day' && day === 'today') {
    ...
    const startDate = (0, _filterExpressions.filterDateTimeModelToDate)(start);
    const endDate = (0, _filterExpressions.addDays)((0, _filterExpressions.filterDateTimeModelToDate)(end), -1);
    return {
      from: startDate,
      to: endDate
    };
...
const relativeTimeframeModelToFilterModel = relativeTimeframe => {
  ...
  const startDateModel = (0, _filterExpressions.dateToFilterDateTimeModel)(dayRange.from);
  const endPlusOne = (0, _filterExpressions.addDays)(dayRange.to, 1);
  const endDateModel = (0, _filterExpressions.dateToFilterDateTimeModel)(endPlusOne);
  return {
    end: endDateModel,
