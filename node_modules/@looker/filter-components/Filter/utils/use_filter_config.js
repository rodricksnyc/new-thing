...
export var useFilterConfig = function useFilterConfig(props) {
  var _useState = useState(getSkipFallback(props)),
      _useState2 = _slicedToArray(_useState, 2),
      skipFallback = _useState2[0],
      setSkipFallback = _useState2[1];

  var skipFallbackConfigCheckRef = useRef(props.skipFilterConfigCheck);
  ...
  var uiConfig = skipFallback ? props.config || {} : getFallbackFilterConfig(props.config);
  return {
