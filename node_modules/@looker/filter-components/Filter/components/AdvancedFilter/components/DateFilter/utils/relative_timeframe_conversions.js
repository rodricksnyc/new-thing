...
export var filterModelToRelativeTimeframeModel = function filterModelToRelativeTimeframeModel(filterModel) {
  ...
  if (type === 'day' && day === 'today') {
    ...
    var startDate = filterDateTimeModelToDate(start);
    var endDate = addDays(filterDateTimeModelToDate(end), -1);
    return {
      from: startDate,
      to: endDate
    };
...
export var relativeTimeframeModelToFilterModel = function relativeTimeframeModelToFilterModel(relativeTimeframe) {
  ...
  var startDateModel = dateToFilterDateTimeModel(dayRange.from);
  var endPlusOne = addDays(dayRange.to, 1);
  var endDateModel = dateToFilterDateTimeModel(endPlusOne);
  return {
    end: endDateModel,
