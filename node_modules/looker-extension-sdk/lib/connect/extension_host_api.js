...
class ExtensionHostApiImpl {
  ...
  sendAndReceive(type, payload) {
    ...
    return _asyncToGenerator(function* () {
      ...
      return _this17.chattyHost.sendAndReceive(_types.ExtensionEvent.EXTENSION_API_REQUEST, {
        type,
        payload
  ...
  validateAuthParameters(authParameters) {
    ...
    if (authParameters.response_type !== 'token' && authParameters.response_type !== 'id_token' && authParameters.response_type !== 'code') {
      return "invalid response_type, must be token or code, ".concat(authParameters.response_type);
    }
